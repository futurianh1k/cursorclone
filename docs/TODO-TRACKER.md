...
**최종 업데이트**: 2026-01-03 (P0-P2 작업 완료)  
**총 TODO 수**: 37개 (apps/ 내), **11개 완료**
...
| 파일 | 라인 | TODO | 우선순위 | 상태 |
|------|------|------|----------|------|
| `routers/workspaces.py` | 66, 216 | DB에 메타데이터 저장 | P2 | 대기 |
| `routers/workspaces.py` | 107 | 사용자 권한에 따른 목록 필터링 | P2 | 대기 |
| `routers/workspaces.py` | 108 | 페이지네이션 지원 | P2 | 대기 |
